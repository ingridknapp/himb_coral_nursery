...
brick_id_Pplot <- ggplot (data=brick_id_point, aes(x=brick_id, y=mean, colour=genotype, fill=brick_id))+
  geom_point(stat="identity")
brick_id_Pplot
...
brick_id_Pplot <- ggplot (data=brick_id_point_side, aes(x=brick_id, y=mean, colour=genotype, fill=brick_id))+
  geom_point(stat="identity")
brick_id_Pplot
...
#First going to parse out useful columns to new data frame

df<-data %>% 
select(brick_colour,side)
